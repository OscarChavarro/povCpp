...
class ParametricBiCubicIntersection {
  public:
    static int intersectSubpatch(int patchType, RayWithSegments *ray, Vector3Dd *v1, Vector3Dd *v2,
    ...
    static int sphericalBoundsCheck(RayWithSegments *ray, Vector3Dd *center, double radius);
