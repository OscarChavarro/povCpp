...
int
All_CSG_Union_Intersections(SimpleBody *Object, Ray *ray, PriorityQueueNode *Depth_Queue)
{
...
int
All_CSG_Intersect_Intersections(SimpleBody *Object, Ray *ray, PriorityQueueNode *Depth_Queue)
{
        ...
        for (Local_Intersection = Local_Depth_Queue->getHighest();
            ...
            for (Shape2 = Shape -> Shapes;
                ...
                if (Shape2 != Local_Shape)
                    if (!Inside (&Local_Intersection->Point, (SimpleBody *) Shape2)) {
                        Intersection_Found = FALSE;
                        break;
                    }
...
Translate_CSG(SimpleBody *Object, Vector3D *Vector)
{
    ...
    for (Local_Shape = ((CSG *) Object) -> Shapes;
                  Local_Shape != NULL ;
                  Local_Shape = Local_Shape -> Next_Object)
