    ...
    case X_AXIS:
        if ((triangle->P2.y - triangle->P3.y)*(triangle->P2.z - triangle->P1.z) <
            ...
            if (triangle->Type == SMOOTH_TRIANGLE_TYPE) {
                ...
                ((SmoothTriangle *) triangle)->N2 = ((SmoothTriangle *) triangle)->N1;
...
int
All_Triangle_Intersections(SimpleBody *Object, Ray *Ray, PriorityQueueNode *Depth_Queue)
{
...
void
Triangle_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point)
{
...
void
Smooth_Triangle_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point)
{
