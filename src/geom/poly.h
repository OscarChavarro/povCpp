...
extern int All_Poly_Intersections(SimpleBody *Object, Ray *Ray, PriorityQueueNode *Depth_Queue);
extern int Inside_Poly(Vector3D *point, SimpleBody *Object);
extern void Poly_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point);
