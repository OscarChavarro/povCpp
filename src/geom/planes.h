...
extern int All_Plane_Intersections(SimpleBody *Object, Ray *Ray, PriorityQueueNode *Depth_Queue);
extern int Intersect_Plane(Ray *Ray, InfinitePlane *Plane, DBL *Depth);
extern int Inside_Plane(Vector3D *point, SimpleBody *Object);
extern void Plane_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point);
