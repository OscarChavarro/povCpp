...
extern int All_Quadric_Intersections(SimpleBody *Object, Ray *Ray, PriorityQueueNode *Depth_Queue);
extern int Intersect_Quadric(Ray *Ray, Quadric *Shape, DBL *Depth1, DBL *Depth2);
extern int Inside_Quadric(Vector3D *point, SimpleBody *Object);
extern void Quadric_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point);
