...
int
All_Quadric_Intersections(SimpleBody *Object, Ray *ray, PriorityQueueNode *Depth_Queue)
{
...
void
Quadric_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point)
{
