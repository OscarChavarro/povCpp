...
Methods Sphere_Methods = {
    Object_Intersect, All_Sphere_Intersections, Inside_Sphere, Sphere_Normal,
    Copy_Sphere, Translate_Sphere, Rotate_Sphere, Scale_Sphere, Invert_Sphere};
...
int
All_Sphere_Intersections(SimpleBody *Object, Ray *Ray, PriorityQueueNode *Depth_Queue)
{
    DBL Depth1, Depth2;
...
void
Sphere_Normal(Vector3D *Result, SimpleBody *Object, Vector3D *Intersection_Point)
{
    Sphere *sphere = (Sphere *) Object;
