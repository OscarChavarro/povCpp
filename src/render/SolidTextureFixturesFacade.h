...
class SolidTextureFixturesFacade {
  ...
  public:
    ...
    void colorAt(
        ...
        Matrix4x4d *textureTransformationInverse, ControlledRGBAImageHDRUncompressed *image,
        ...
        ControlledRGBAImageHDRUncompressed *image1 = nullptr, ColorRgba *color1_1 = nullptr,
        ...
        ControlledRGBAImageHDRUncompressed *image2 = nullptr, ColorRgba *color1_2 = nullptr,
