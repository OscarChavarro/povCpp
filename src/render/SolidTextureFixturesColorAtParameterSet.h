#ifndef __SOLID_TEXTURE_FIXTURES_COLOR_AT_PARAMETER_SET__
#define __SOLID_TEXTURE_FIXTURES_COLOR_AT_PARAMETER_SET__
...
class SolidTextureFixturesColorAtParameterSet {
  public:
