...
class FileHandle {
  public:
    ...
    int  (*Open_File_p)(FileHandle *handle,
        char *name, int *width, int *height, int buffer_size,
        int mode);
    void (*Write_Line_p)(FileHandle *handle,
        RGBAColor *line_data, int line_number);
    int  (*Read_Line_p)(FileHandle *handle,
        RGBAColor *line_data, int *line_number);
...
extern int Open_Dump_File(FileHandle *handle, char *name, int *width, int *height, int buffer_size, int mode);
void Write_Dump_Line(FileHandle *handle, RGBAColor *line_data, int line_number);
extern int Read_Dump_Line(FileHandle *handle, RGBAColor *line_data, int *line_number);
extern int Read_Dump_Int_Line(FileHandle *handle, ImageLine *line_data, int *line_number);
