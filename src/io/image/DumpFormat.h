...
inline char *
defaultFileName(FileHandle *h)
{
    return ((*((h)->Default_File_Name_p))());
}

inline int
openFile(FileHandle *h, char *n, int *wd, int *ht, int sz, int m)
{
...
class DumpFormat {
  public:
    ...
    static inline void
    writeLine(FileHandle *h, RGBAColor *l, int n)
    {
        ((*((h)->Write_Line_p))(h, l, n));
    }
    static inline int
    readLine(FileHandle *h, RGBAColor *l, int *n)
    {
        return ((*((h)->Read_Line_p))(h, l, n));
    }
    static inline void
    readImage(FileHandle *h, RGBAImage *i)
    {
        (((*((h)->Read_Image_p))(i, (h)->filename)));
    }
    static inline void
    closeFile(FileHandle *h)
    {
        ((*((h)->Close_File_p))(h));
    }
};
