...
extern int Open_Raw_File(FileHandle *handle, char *name, int *width, int *height, int buffer_size, int mode);
void Write_Raw_Line(FileHandle *handle, RGBAColor *line_data, int line_number);
extern int Read_Raw_Line(FileHandle *handle, RGBAColor *line_data, int *line_number);
