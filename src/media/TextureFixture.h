...
class TextureFixture {
  public:
    ...
    static void bumpy1(double x, double y, double z, Texture *texture, Vector3Dd *normal);
    static void bumpy2(double x, double y, double z, Texture *texture, Vector3Dd *normal);
    static void bumpy3(double x, double y, double z, Texture *texture, Vector3Dd *normal);
};
