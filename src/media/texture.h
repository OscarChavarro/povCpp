...
extern void Compute_Colour(RGBAColor *Colour, RGBAColorPalette *Colour_Map, DBL value);
...
extern void setup_lattice(DBL *x, DBL *y, DBL *z, long *ix, long *iy, long *iz, long *jx, long *jy, long *jz, DBL *sx, DBL *sy, DBL *sz, DBL *tx, DBL *ty, DBL *tz);
