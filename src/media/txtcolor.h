...
extern void Colour_At(RGBAColor *Colour, Texture *Texture, Vector3D *Intersection_Point);
...
extern void checker_texture(DBL x, DBL y, DBL z, Texture *Texture, RGBAColor *colour);
...
extern void leopard(DBL x, DBL y, DBL z, Texture *Texture, RGBAColor *colour);    /* SWT 7/18/91 */
