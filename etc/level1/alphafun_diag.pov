// Diagnostic version: box uses Blue instead of Clear to test geometry
#include "shapes.inc"
#include "colors.inc"
...
// A sliced green box — DIAGNOSTIC: use Blue instead of Clear
object { box { UnitBox
      scale <1 1 1>
      rotate <0 45 0>
      translate <-4 1 4>
